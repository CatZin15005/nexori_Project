...
Nexori contem as funcionalidades de Alarmes e Lembretes Por via de Notificação que pode ser definida pelo proprio usuario

atualmente contando com:

lembretes especiais:
que o proprio usuario define e que irá alertar o usuario a completar uma tarefa ou lembrar algo por via de notificações a cada 1 a 1 hora, 2 a 2 horas e etc conta com sistemas de inicio e fim das notificaçoes
